...
function App() {
  ...
  const startQuiz = useCallback(
    (
      ...
      rawStartQuiz(mode, domain, scenario, customQuestions);
      navigate("/quiz");
    },
    [rawStartQuiz, navigate]
  );

  const resetQuiz = useCallback(() => {
    rawResetQuiz();
    navigate("/");
  }, [rawResetQuiz, navigate]);
...
interface HomeScreenProps {
  ...
  activeQuestions: ReturnType<typeof useQuiz>["activeQuestions"];
    ...
    <div className="app">
      <header className="home-header">
        <div className="social-links">
          ...
          <a
            href="https://www.linkedin.com/in/magnus-rodseth/"
            target="_blank"
            rel="noopener noreferrer"
            title="LinkedIn"
          >
          ...
          <div className="domain-mastery">
            ...
            <div className="mastery-legend">
              <span className="legend-item">
                <span className="legend-dot mastered" /> Mastered (2+ correct
                streak)
              </span>
              <span className="legend-item">
          ...
          <section className="resume-banner">
            <div className="resume-content">
              ...
              <div className="resume-detail">
                {state.mode} / Question {state.currentQuestionIndex + 1} of{" "}
                {activeQuestions.length} (
                {Object.keys(state.answers).length} answered)
              </div>
            </div>
            <div className="resume-actions">
              <button className="btn primary" onClick={resumeQuiz}>
                Resume
              </button>
            ...
            return (
              ...
              >
                ...
                <div className="domain-bar-container">
                  <div className="domain-bar" style={{ width: `${dp}%` }} />
                </div>
